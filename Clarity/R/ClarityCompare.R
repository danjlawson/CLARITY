...
c_crossvalidate=function(datalist,kmax=NULL,...){
    ...
    scoredist=stats::ecdf(apply(scoremat,2,which.min))
...
#' @param reg (Default=1) regularisation; add a null sample with this value to ensure that zero probability is not assigned to very small values.
